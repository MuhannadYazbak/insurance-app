...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  getClientRelations: (clientId: number) => ipcRenderer.invoke('getClientRelations', clientId),
  addClientRelation: (payload: { clientId: number; relatedClientId: number; relationType: string }) => ipcRenderer.invoke('addClientRelation', payload),
  deleteClientRelation: (payload: { clientId: number; relatedClientId: number }) => ipcRenderer.invoke('deleteClientRelation', payload),
  getAllClientsMinimal: () => ipcRenderer.invoke('getAllClientsMinimal'),
});